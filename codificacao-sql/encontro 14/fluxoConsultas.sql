...
/*select cf.nome, max(fc.valor)  as 'maior valor' from fluxoCaixa fc
inner join clienteFornecedor cf on fc.clientefornecedorid = cf.clientefornecedorid
where fc.tipoTransacao = 'entrada' and
fc.datahora > '20210701 00:00:00' and fc.datahora < '20210702 23:59:00'
group by cf.nome;*/